...
description: Token-efficient Serena MCP command for structured app development and problem-solving (日本語対応版)
---

## 🇯🇵 Language Settings (言語設定)
**重要: すべての応答は日本語で行ってください。**
- 説明、分析、提案はすべて日本語で記述
- コード内のコメントは互換性のため英語でも可
- エラーメッセージ、ユーザー向けテキストは日本語
...
**Key Guidelines:**
- **言語 (LANGUAGE)**: すべての説明、分析、提案、応答を日本語で提供してください
...
- 日本語での応答例:
  - "バグを修正しました" (not "Fixed the bug")
  - "以下の改善点を実装します：" (not "Implementing the following improvements:")
  - "エラーの原因は〜です" (not "The error is caused by...")
