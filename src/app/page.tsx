  ...
  return (
    <>
      ...
      <header className={`header ${headerHidden ? 'hero-hidden' : ''}`}>
        <nav className="nav">
          <a href="index.html" className="logo jp-title">木村屋本店</a>
        ...
        <div className="hero-bg">
          <div className="hero-slider">
            ...
            <div className="hero-slide hero-slide-desktop active">
              <img src="/images/DSC00442.jpg" alt="木村屋本店 メインビジュアル1" />
            </div>
            <div className="hero-slide hero-slide-desktop">
              <img src="/images/DSC00456.jpg" alt="木村屋本店 メインビジュアル2" />
            </div>
            <div className="hero-slide hero-slide-desktop">
              <img src="/images/DSC00398.jpg" alt="木村屋本店 メインビジュアル3" />
            </div>
            <div className="hero-slide hero-slide-desktop">
              <img src="/images/DSC00406.jpg" alt="木村屋本店 メインビジュアル4" />
            </div>
            
            {/* スマホ用 */}
            <div className="hero-slide hero-slide-mobile">
              <img src="/images/DSC00400.jpg" alt="木村屋本店 スマホ用1" />
            </div>
            <div className="hero-slide hero-slide-mobile">
              <img src="/images/DSC00480.jpg" alt="木村屋本店 スマホ用2" />
            </div>
            <div className="hero-slide hero-slide-mobile">
              <img src="/images/DSC00653.jpg" alt="木村屋本店 スマホ用3" />
            </div>
          </div>
        </div>
        <div className="hero-content">
          <img src="/images/log.png" alt="木村屋本店" className="hero-logo fade-up" />
          <h1 className="hero-title fade-up">
            <span className="desktop-text">博多もつ鍋専門店</span>
            <span className="mobile-text">博多<br />もつ鍋<br />専門店</span>
          </h1>
          <p className="hero-subtitle fade-up">
            <span className="desktop-text">九州料理と美酒で楽しい宴会を</span>
            <span className="mobile-text">九州料理と美酒で<br />楽しい宴会を</span>
          </p>
        </div>
        <div className="hero-info fade-up">
          <span>OPEN 10:00</span>
          <span>CLOSE 22:00</span>
          <span>定休日 水曜日</span>
        </div>
      </section>
      ...
      <section className="craft-section" id="craft">
        <div className="craft-grid-container">
          <div className="craft-vertical-text">
            <h2 className="craft-vertical-title jp-title fade-up">ちょっとは九州じゃない料理</h2>
          </div>
          
          <div className="craft-vertical-text-right">
            <h2 className="craft-vertical-title-right jp-title fade-up">九州料理と美味い酒</h2>
          </div>
          
          <div className="craft-image-1">
            <img src="/images/DSC00473.jpg" alt="こだわりの食材" className="craft-img fade-up" loading="lazy" />
            <div className="craft-image-overlay"></div>
          </div>
          
          <div className="craft-image-2">
            <img src="/images/no1-0357.jpg" alt="ちょっとは九州じゃない料理" className="craft-img fade-up" loading="lazy" />
            <div className="craft-image-overlay"></div>
          </div>
          
          <div className="craft-image-3">
            <img src="/images/no1-0208.jpg" alt="こだわりの料理" className="craft-img fade-up" loading="lazy" />
            <div className="craft-image-overlay"></div>
          </div>
        </div>
      </section>
      ...
      <section className="features-section" id="features">
        <div className="features-grid">
          ...
          <div className="feature-card masked-content order-mobile-2">
            <img src="/images/no1-0241.jpg" alt="こだわりの食材" className="feature-image" loading="lazy" />
            <div className="feature-content">
              <div className="feature-number">01</div>
              <h3 className="feature-title jp-title">当店名物！<br />こだわりの博多もつ鍋</h3>
              <p className="feature-description">
                厳選した国産牛もつと秘伝の特製スープで作る本場博多の味。
                味噌・醤油・塩・辛味噌の4種類から選べ、〆のちゃんぽん麺や雑炊まで堪能できます。
              </p>
          ...
          <div className="feature-card text-overlay order-mobile-1">
            <div className="feature-content">
              <h3 className="feature-title jp-title fade-up">当店の４つのこだわり</h3>
              <p className="feature-description">
          ...
          <div className="feature-card masked-content order-mobile-3">
            <img src="/images/DSC00440.jpg" alt="多彩な味" className="feature-image" loading="lazy" />
            <div className="feature-content">
              <div className="feature-number">02</div>
              <h3 className="feature-title jp-title">季節の食材と調理で<br />味わう逸品料理</h3>
              <p className="feature-description">
                本マグロ入りお刺身盛り合わせ、馬刺しユッケ、桜鯛のなめろうなど
                旬の食材を活かした料理と季節限定メニューをご提供。
              </p>
              <div className="feature-accent"></div>
            </div>
          </div>
          ...
          <div className="feature-card masked-content order-mobile-4">
            <img src="/images/DSC00689.jpg" alt="充実の逸品" className="feature-image" loading="lazy" />
            <div className="feature-content">
              <div className="feature-number">03</div>
              <h3 className="feature-title jp-title">幹事様に朗報！<br />大好評宴会コース</h3>
              <p className="feature-description">
                3時間飲み放題付きコースや食べ飲み放題プランなど多彩なコースをご用意。
                最大110名様までの貸切も可能で、各種宴会に最適です。
              </p>
              <div className="feature-accent"></div>
            </div>
          </div>
          ...
          <div className="feature-card masked-content order-mobile-5">
            <img src="/images/DSC00424.jpg" alt="和の空間" className="feature-image" loading="lazy" />
            <div className="feature-content">
              <div className="feature-number">04</div>
              <h3 className="feature-title jp-title">様々なシーンに<br />最適な各種空間</h3>
              <p className="feature-description">
                半個室風ボックス席、窓際デート席、グループ席など多彩な席をご用意。
                2名様から最大110名様の貸切まで、あらゆるシーンに対応可能です。
              </p>
              <div className="feature-accent"></div>
            </div>
          </div>
      ...
      <section className="room-section" id="room">
        <div className="room-container">
          <h2 className="section-title jp-title fade-up">お品書き</h2>
          <p className="section-subtitle fade-up">心安らぐ空間で、特別なひとときを</p>
      ...
      <section className="dining-style-section" id="dining-style">
        <div className="dining-style-container">
          <h2 className="dining-section-title fade-up">選べる当店の楽しみ方！</h2>
          <div className="dining-style-grid">
            {/* 左カラム：宴会 */}
            <div className="dining-column dining-party">
              <div className="dining-bg-image dining-party-bg"></div>
              <div className="dining-overlay"></div>
              <div className="dining-content">
                <div className="dining-header">
                  <span className="dining-subtitle">PARTY</span>
                  <h3 className="dining-title jp-title">宴会</h3>
                </div>
                <div className="dining-description">
                  <p>大切な仲間との語らいに、木村屋本店<small style={{color: "rgba(255,255,255,0.8)", fontSize: "0.85em"}}>サンプル店</small>の個室をご用意。<br />
                  四季折々の食材を活かした会席料理で、<br />
                  記憶に残るひとときをお届けします。</p>
                ...
                <a href="#" className="dining-cta-btn" onClick={(e) => { e.preventDefault(); setShowCoursesModal(true); }}>
                  <span>コース料理を見る</span>
            ...
            <div className="dining-column dining-sake">
              <div className="dining-bg-image dining-sake-bg"></div>
              <div className="dining-overlay"></div>
              <div className="dining-content">
                <div className="dining-header">
                  <span className="dining-subtitle">SAKE</span>
                  <h3 className="dining-title jp-title">お酒</h3>
                </div>
                <div className="dining-description">
                  <p>全国から厳選した日本酒と焼酎。<br />
                  季節限定の銘柄から定番まで、<br />
                ...
                <a href="#" className="dining-cta-btn" onClick={(e) => { e.preventDefault(); setShowDrinksModal(true); }}>
                  <span>お酒メニューを見る</span>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M5 12h14M12 5l7 7-7 7"/>
                  </svg>
      ...
      <section className="seats-section" id="seats">
        <div className="seats-container">
          <div className="seats-header fade-up">
            <h2 className="seats-title jp-title">お席のご案内</h2>
            <p className="seats-subtitle">大切なひとときを過ごすための、さまざまな空間をご用意</p>
          </div>
              ...
              <div className="seats-slides">
                ...
                <div className="seat-slide active" data-seat="0">
                  <div className="seat-image">
                    <img src="/images/DSC00424.jpg" alt="貸切スペース" loading="lazy" />
                  </div>
                ...
                <div className="seat-slide" data-seat="1">
                  <div className="seat-image">
                    <img src="/images/DSC00401.jpg" alt="半個室風ボックス席" loading="lazy" />
                  </div>
                  <div className="seat-details">
                ...
                <div className="seat-slide" data-seat="2">
                  <div className="seat-image">
                    <img src="/images/DSC00406.jpg" alt="テーブル席" loading="lazy" />
                  </div>
                  <div className="seat-details">
                ...
                <div className="seat-slide" data-seat="3">
                  <div className="seat-image">
                    <img src="/images/DSC00429.jpg" alt="グループ席" loading="lazy" />
                  </div>
                  <div className="seat-details">
                ...
                <div className="seat-slide" data-seat="4">
                  <div className="seat-image">
                    <img src="/images/DSC00396.jpg" alt="窓際デート席" loading="lazy" />
                  </div>
                  <div className="seat-details">
      ...
      <section className="gallery-section" id="gallery">
        <div className="gallery-container">
          <div className="gallery-header fade-up">
            <h2 className="gallery-title jp-title">フォトギャラリー</h2>
            <p className="gallery-subtitle">木村屋本店の様々な風景</p>
          </div>
          
          <div className="gallery-grid">
            {/* メイン画像（PC/タブレットで全表示、スマホで３枚） */}
            <div className="gallery-item fade-up">
              <img src="/images/no1-0241.jpg" alt="木村屋本店サンプル店の風景1" className="gallery-image" />
              <div className="gallery-overlay">
                <span className="gallery-caption">店内の雰囲気</span>
              </div>
            </div>
            <div className="gallery-item fade-up">
              <img src="/images/no1-0283.jpg" alt="木村屋本店サンプル店の風景2" className="gallery-image" />
              <div className="gallery-overlay">
                <span className="gallery-caption">ちょっとは九州じゃない料理</span>
              </div>
            </div>
            <div className="gallery-item fade-up">
              <img src="/images/no1-0361.jpg" alt="木村屋本店サンプル店の風景3" className="gallery-image" />
              <div className="gallery-overlay">
            ...
            <div className="gallery-item fade-up desktop-only">
              <img src="/images/no1-0151.jpg" alt="木村屋本店サンプル店の風景4" className="gallery-image" />
              <div className="gallery-overlay">
                <span className="gallery-caption">カウンター席</span>
              </div>
            </div>
            <div className="gallery-item fade-up desktop-only">
              <img src="/images/DSC00439.jpg" alt="木村屋本店サンプル店の風景5" className="gallery-image" />
              <div className="gallery-overlay">
                <span className="gallery-caption">こだわりの内装</span>
              </div>
            </div>
            <div className="gallery-item fade-up desktop-only">
              <img src="/images/DSC00680.jpg" alt="木村屋本店サンプル店の風景6" className="gallery-image" />
              <div className="gallery-overlay">
            ...
            <div className={`gallery-item fade-up hidden-mobile ${showAllGallery ? 'show' : ''}`} data-extra="true">
              <img src="/images/DSC00571.jpg" alt="木村屋本店サンプル店の風景7" className="gallery-image" />
              <div className="gallery-overlay">
                <span className="gallery-caption">広々とした客席</span>
              </div>
            </div>
            <div className={`gallery-item fade-up hidden-mobile ${showAllGallery ? 'show' : ''}`} data-extra="true">
              <img src="/images/DSC00566.jpg" alt="木村屋本店サンプル店の風景8" className="gallery-image" />
              <div className="gallery-overlay">
                <span className="gallery-caption">特別個室</span>
              </div>
            </div>
            <div className={`gallery-item fade-up hidden-mobile ${showAllGallery ? 'show' : ''}`} data-extra="true">
              <img src="/images/DSC00527.jpg" alt="木村屋本店サンプル店の風景9" className="gallery-image" />
              <div className="gallery-overlay">
      ...
      <section className="info-section" id="info">
        <div className="container">
          <h2 className="section-title jp-title fade-up">店舗案内</h2>
          ...
          <dl className="info-list">
            ...
            <dt>住所</dt>
            <dd>神奈川県横浜市神奈川区鶴屋町2-15<br />エフテム白十字ビル&nbsp;2F・3F</dd>
            ...
            <dt>営業時間</dt>
            <dd>月～金: 17:00～23:30 (L.O.23:00)<br />土日祝: 16:00～23:30 (L.O.23:00)</dd>
            
            <dt>定休日</dt>
            <dd>無休</dd>
            
            <dt>席数</dt>
            <dd>110席（貸切最大110名様まで）</dd>
      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-left">
            <div className="footer-logo jp-title">木村屋本店<small style={{color: "rgba(255,255,255,0.8)", fontSize: "0.7em", display: "block", marginTop: "5px", fontWeight: 300}}>サンプル店</small></div>
          ...
          <div className="footer-right">
            <div className="footer-info-group">
              <div className="footer-info-item">
                ...
                <span className="footer-value">〒150-0001 東京都渋谷区神宮前4-12-10</span>
              </div>
              <div className="footer-info-item">
                <span className="footer-label">アクセス</span>
                <span className="footer-value">横浜駅きた西口 徒歩1分</span>
              </div>
              <div className="footer-info-item">
                <span className="footer-label">営業時間</span>
                <span className="footer-value">月～金: 17:00～23:30 (L.O.23:00)<br />土日祝: 16:00～23:30 (L.O.23:00)</span>
              </div>
              <div className="footer-info-item">
                <span className="footer-label">定休日</span>
                <span className="footer-value">無休</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <p className="copyright">&copy; 2024 木村屋本店. All rights reserved.</p>
            ...
            <div className="courses-slider">
              ...
              <div className={`course-slide ${currentCourseSlide === 0 ? 'active' : ''}`}>
                <div className="course-header">
                  <h2 className="course-title">～夏の宴会～<br />3時間飲み放題付き！夏の食材＆佐賀牛を堪能</h2>
                ...
                <div className="course-body">
                  <div className="course-price">
                    ...
                    <span className="price-note">(税込)</span>
                  </div>
              ...
              <div className={`course-slide ${currentCourseSlide === 1 ? 'active' : ''}`}>
                <div className="course-header">
                  <h2 className="course-title">もつ鍋食べ飲み放題♪<br />２時間　4,280円</h2>
                  <p className="course-subtitle">※金曜日・土曜日のご利用は＋300円になります</p>
                </div>
                <div className="course-body">
                  <div className="course-price">
                    <span className="price-amount">4,280</span>
                    <span className="price-unit">円</span>
                    <span className="price-note">(税込)</span>
                  </div>
                  <div className="course-info">
              ...
              {/* スライド3 */}
              <div className={`course-slide ${currentCourseSlide === 2 ? 'active' : ''}`}>
                <div className="course-header">
                  <h2 className="course-title">2.5時間飲み放題<br />佐賀牛の朴葉焼き＆本マグロを愉しむ<br />全10品 雅コース</h2>
                </div>
                <div className="course-body">
                  <div className="course-price">
                  ...
                  <div className="course-info">
                    <div className="course-items">全<span>10</span>品</div>
                    <p className="course-description">馬刺しユッケ、桜鯛のなめろう、本マグロのトロたく、佐賀牛の朴葉焼きなど豪華10品。</p>
                    <div className="course-features">
                      <div className="feature-item">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                          <path d="M9 11l3 3L22 4"/>
              ...
              {/* スライド4 */}
              <div className={`course-slide ${currentCourseSlide === 3 ? 'active' : ''}`}>
                <div className="course-header">
                  <h2 className="course-title">最大2.5時間飲み放題<br />旬の海鮮＆米沢豚を愉しむ<br />全10品 匠コース</h2>
                  <p className="course-subtitle">金曜・土曜は2時間でのご案内になります</p>
                </div>
                <div className="course-body">
                  <div className="course-price">
                  ...
                  <div className="course-info">
                    <div className="course-items">全<span>10</span>品</div>
                    <p className="course-description">旬の鮮魚・海鮮料理と特製博多もつ鍋、米沢豚を本格的に楽しめるコース。</p>
                    <div className="course-features">
                      <div className="feature-item">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                          <path d="M9 11l3 3L22 4"/>
              ...
              {/* スライダーコントロール */}
              <button className="slider-control prev" onClick={() => setCurrentCourseSlide((prev) => prev === 0 ? 3 : prev - 1)}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M15 18l-6-6 6-6"/>
                </svg>
              </button>
              <button className="slider-control next" onClick={() => setCurrentCourseSlide((prev) => (prev + 1) % 4)}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M9 18l6-6-6-6"/>
                </svg>
              </button>
              ...
              <div className="slider-dots">
                ...
                <button className={`slider-dot ${currentCourseSlide === 2 ? 'active' : ''}`} onClick={() => setCurrentCourseSlide(2)}></button>
                <button className={`slider-dot ${currentCourseSlide === 3 ? 'active' : ''}`} onClick={() => setCurrentCourseSlide(3)}></button>
              </div>
            </div>
          </div>
        </div>
